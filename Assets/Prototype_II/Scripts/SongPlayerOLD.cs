...
{
    public class SongPlayerOLD : GameBehaviour<SongPlayerOLD>  
    {
        [Header("Song Loaders")]
        [SerializeField] private SongData songData;
        //[SerializeField] private List<NoteID> beatList;
        ...
        */
        private void MoveNotes()
        {
            ...
            for (int i = 0; i < beatsInPlay.Count; i++)
            {
                ...
                //noteToMove.GetComponent<NoteBehaviour>().MoveNote(SPB);
            }
        }
        ...
        public void DestroyNote(int _beatToDestroy)
        {
            for (int i = beatsInPlay.Count - 1; i >= 0; i--)
            {
                ...
                NoteBehaviour beat = beatObj.GetComponent<NoteBehaviour>();
